...
namespace TodoAppBackend.Migrations
{
    ...
    [Migration("20240901125706_AddTableMessage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodoAppBackend.Message", b =>
                {
            ...
            modelBuilder.Entity("TodoAppBackend.Message", b =>
                {
                    b.HasOne("TodoAppBackend.User", "Receiver")
                        .WithMany("MessageReceived")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TodoAppBackend.User", "Sender")
